...
WORKFLOW_NAME=cal_${INJECTION_TIME}_${EVENT}_${IFO}_${MODEL}model_test
...
pycbc_submit_dax --dax ${WORKFLOW_NAME}/${WORKFLOW_NAME}.dax --accounting-group sugwg.astro
